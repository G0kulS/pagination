var data = [
  ...
  console.log(data);
  var length = Math.floor(data.length/10);
  if(data.length%10!=0)
  {
    length++;
  }
 ...
 // var center = Math.floor(arr.length/2);
  ...
  for(let j =0 ; j <arr.length;j++)
  {
    ...
    button.setAttribute("id","button"+arr[j]);
    button.innerText=arr[j];
    span.append(button);
  }
  arrange(1);
  document.querySelector("#first").addEventListener("click",()=>
  {
     ...
     {
      document.querySelector("#button"+i).innerText = i ; 
     }
     currentpage =1
     arrange(currentpage);
  })
  ...
  {  
    ...
    {
     document.querySelector("#button"+i).innerText = d ;
     d--; 
    }
    currentpage = length;
    arrange(currentpage);
  ...
  {  
     currentpage = +document.querySelector("#button1").innerText ;
      arrange(currentpage); 
  ...
  {
    currentpage = +document.querySelector("#button2").innerText ;
    arrange(currentpage);
  }
  )
  document.querySelector("#button3").addEventListener("click",()=>
  {
    currentpage = +document.querySelector("#button3").innerText ;
      arrange(currentpage);
  }
  )
  document.querySelector("#button4").addEventListener("click",()=>
  {
    currentpage = +document.querySelector("#button4").innerText ;
    arrange(currentpage);
  }
  )
  document.querySelector("#button5").addEventListener("click",()=>
  {
    currentpage = +document.querySelector("#button5").innerText ;
      arrange(currentpage); 
  }
  ) }
  catch(err)
  ...
  { 
    ...
    if(num>2)
    {
     // alert("no changes required");
      let change = num - +(document.querySelector("#button3").innerText) ; 
       numchange(change);
    }
    highlight(i);
 }
function numchange(change)
{
  if(change>0)
      {
     // console.log(change);
      var start =0;
      if((+(document.querySelector("#button"+(arr.length-1)).innerText) + change)>=10)
      {
        change = 1 ;
      ...
      {     
         //  console.log(+(document.querySelector("#button"+(arr.length)).innerText));
          
         if(+(document.querySelector("#button"+(arr.length)).innerText)<length)
          {
          document.querySelector("#button"+k).innerText= +(document.querySelector("#button"+k).innerText) + change;
        }
      }
    } else
    {
      ...
      {     
         ...
         if(+(document.querySelector("#button"+(arr.length)).innerText)>0)
          {
          document.querySelector("#button"+k).innerText= +(document.querySelector("#button"+k).innerText) + change;
        }
    }
...
{  
   ...
   let g =1 ;
   let k =d
   for(;(k<(d+10))&&(k<data.length);k++)
   {  
     console.log(k);
      document.querySelector("#data"+(g)).innerHTML= "ID : "+data[k].id +"<br> Name : " +data[k].name +
      "<br> E-Mail :" +data[k].email;
      g++;
   }
   if(k!=(d+10))
   {
     for(;k<(d+10);k++)
     {
      document.querySelector("#data"+(g)).innerText="";
      g++;
     }
   }
}

function highlight(cpage)
{
  for(let k =0 ; k<arr.length;k++)
  {
    let parbut =document.querySelector("#button"+arr[k]); 
    if(parbut.innerText==cpage)
    {
       parbut.setAttribute("style"," background-color:lightgreen;");
    }
    else
    {
      parbut.setAttribute("style","background-color:gray;");
    }
  }  
}
